...
module.exports = function tasksCall() {
    ...
    tl.tasks.all(function(response, key, value) {
        ...
        var query = connection.query('INSERT IGNORE INTO tasks(taskId, qty, estMins, loggedMins, loggedBillableMins, estCost, estRate, complete, fk_jobId) VALUES ?', [arr1],
