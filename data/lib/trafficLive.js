    ...
    this.api = {
        ...
        allocations: {
            ...
            recent: function(callback) {
                ...
                return self.request(rest.get, '/timeallocations/jobtasks/', { startDate: firstDate }, function(result) {
                    callback(result);
                });
            },
            find: function(filter, callback) {
        ...
        entries: {
            ...
            find: function(start, end, filter, callback) {
                ...
                self.filter = filter;
                return self.request(rest.get, `/timeentries`, { startDate: '2017-02-15', endDate: '2017-02-15' }, function(result) {
                    callback(result);
                });
            },
            one: function(id, callback) {
        ...
        jobs: {
            ...
            find: function(filter, callback) {
                self.filter = filter;
                return self.request(rest.get, `/job/?windowSize=${self.pageSize}&filter=${filter}`, {}, function(result) {
                    callback(result);
                });
            },
